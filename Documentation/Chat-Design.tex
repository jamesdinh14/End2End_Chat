...
\usepackage{graphicx}
\graphicspath{ {C:/Users/Kenny/Desktop/End2End/End2End_Chat/Documentation/Diagrams/}}
\begin{document}
...
\item The clients will hold a pair of keys that will encrypt and decrypt
    ...
    \item If we go with registration (user id and password), consider using JWT, web tokens.
    \item Look for something that provides key exchange. Something that uses PGP.
\end{itemize}
...
\end{enumerate}
Attack Tree \newline
\includegraphics[width=\textwidth]{AttackTree.png}\newline
System Diagram \newline
